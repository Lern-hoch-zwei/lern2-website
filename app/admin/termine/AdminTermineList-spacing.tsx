...
export default function AdminTermineList({ initialTermine }: { initialTermine: Termin[] }) {
  ...
  const selectStyle = {
    padding: '10px 30px 10px 14px', borderRadius: '8px', border: '1px solid #D6E4FF',
    fontSize: '13px', fontFamily: "'Inter', sans-serif", backgroundColor: '#fff',
            ...
            return (
              <div key={t.id} style={{ padding: '14px 16px', borderBottom: '1px solid #F0F4F8' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px', flexWrap: 'wrap' }}>
                  ...
                  <span style={{
                    padding: '8px 14px', borderRadius: '6px', border: `1.5px solid ${info.color}`,
