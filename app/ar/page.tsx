...
export default function HomeAr() {
  ...
  return (
    <main dir="rtl" style={{ fontFamily: "'Tajawal', 'Cairo', 'Segoe UI', 'Inter', sans-serif", backgroundColor: '#ffffff', color: '#0A0A0A', margin: 0 }}>
      <style>{`
      ...
      <section className="hero-section" style={{ position: 'relative', minHeight: '600px', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <img src="/full.png" alt="الخلفية" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
        ...
        <div className="hero-content" style={{ position: 'relative', zIndex: 1, padding: '80px 48px', maxWidth: '700px' }}>
          ...
          <h1 className="hero-h1" style={{ fontSize: 'clamp(30px, 5vw, 58px)', fontWeight: '800', lineHeight: '1.2', color: '#fff', marginBottom: '18px' }}>
            نساعد طفلك على<br />تحقيق<br /><span style={{ color: '#FFD60A' }}>درجات أفضل.</span>
          </h1>
          <p className="hero-p" style={{ fontSize: '17px', color: 'rgba(255,255,255,0.8)', lineHeight: '1.8', marginBottom: '32px', maxWidth: '500px' }}>
            دروس خصوصية فردية ودعم لغوي في كاسل — بشكل شخصي، منظّم، ومجاني تماماً للعديد من العائلات.
          </p>
      ...
      <section className="section-pad" style={{ background: 'linear-gradient(135deg, #EEF4FF 0%, #F7F9FC 100%)', borderBottom: '1px solid #D6E4FF', padding: '72px 32px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          <p style={{ fontSize: '12px', color: '#3A86FF', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '12px', textAlign: 'center', fontWeight: '600' }}>هل تواجه هذا؟</p>
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 36px)', fontWeight: '800', marginBottom: '40px', textAlign: 'center', color: '#0F2A45' }}>كثير من الأهل يواجهون التحديات نفسها.</h2>
          <div className="grid-2" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '14px' }}>
            {[
              { icon: '⏰', text: 'ليس لديك وقت لمساعدة طفلك في الواجبات؟' },
              { icon: '📚', text: 'لم تعد تفهم المنهج الدراسي بنفسك؟' },
              { icon: '🤷', text: 'لا تعرف من أين تبدأ؟' },
              { icon: '🌍', text: 'الألمانية ليست لغتك الأم ولا تستطيع المساعدة؟' },
              { icon: '😟', text: 'طفلك لم يعد يفهم الدروس في المدرسة؟' },
          ...
          <div style={{ textAlign: 'center', marginTop: '36px' }}>
            <p style={{ fontSize: '17px', fontWeight: '700', color: '#0F2A45', marginBottom: '16px' }}>لدينا الحل — احترافي، شخصي، ومجاني للعديد من العائلات.</p>
            <a href="#kontakt" style={{ backgroundColor: '#FFD60A', color: '#0F2A45', padding: '14px 24px', borderRadius: '8px', textDecoration: 'none', fontWeight: '700', fontSize: '15px' }}>استفسر الآن مجاناً</a>
          </div>
        </div>
      </section>
      ...
      <section className="section-pad" style={{ maxWidth: '960px', margin: '0 auto', padding: '72px 32px', textAlign: 'center' }}>
        <p style={{ fontSize: '12px', color: '#3A86FF', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '12px', fontWeight: '600' }}>من نحن</p>
        <h2 style={{ fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: '800', marginBottom: '16px', color: '#0F2A45' }}>ندعم الطلاب في طريقهم نحو درجات أفضل</h2>
        <p style={{ fontSize: '16px', color: '#556678', lineHeight: '1.9', margin: '0 auto 24px', maxWidth: '700px' }}>
          منذ سنوات عديدة نرافق الأطفال والشباب من مختلف الخلفيات لتحقيق كامل إمكاناتهم. من خلال الدروس الخصوصية الفردية والدعم اللغوي، نعزّز المعرفة والثقة بالنفس والأساس لمستقبل ناجح.
        </p>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '36px', justifyContent: 'center' }}>
          {['الرياضيات', 'الألمانية', 'الإنجليزية', 'الفيزياء', 'الكيمياء', 'الأحياء', 'العربية', 'الفرنسية', 'اللاتينية'].map(f => (
          ...
          <span style={{ backgroundColor: '#FFFBEA', color: '#7A6500', border: '1px solid #FFE566', padding: '6px 14px', borderRadius: '20px', fontSize: '13px', fontWeight: '500' }}>لجميع المراحل الدراسية، بما في ذلك اللاجئين</span>
        </div>
      ...
      <section className="section-pad" style={{ background: 'linear-gradient(135deg, #EEF4FF 0%, #F7F9FC 100%)', borderTop: '1px solid #D6E4FF', borderBottom: '1px solid #D6E4FF', padding: '72px 32px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <p style={{ fontSize: '12px', color: '#3A86FF', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '12px', textAlign: 'center', fontWeight: '600' }}>آلية العمل</p>
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: '800', marginBottom: '12px', textAlign: 'center', color: '#0F2A45' }}>خطوة بخطوة نحو درجات أفضل</h2>
          <p style={{ fontSize: '15px', color: '#556678', textAlign: 'center', maxWidth: '560px', margin: '0 auto 52px', lineHeight: '1.8' }}>
            طفلك هو محور اهتمامنا — من أول لقاء حتى النجاح المشترك.
          </p>
          <div style={{ position: 'relative' }}>
            ...
            {[
              { n: '1', icon: '👥', t: 'التعارف والتقييم', d: 'نبدأ بمحادثة شخصية وتقييم شامل لفهم مستوى طفلك واحتياجاته بدقة.', side: 'right' },
              { n: '2', icon: '📅', t: 'خطة تعلّم فردية', d: 'بناءً على التقييم، نضع خطة مخصصة تعزّز نقاط القوة وتعالج نقاط الضعف خطوة بخطوة.', side: 'left' },
              { n: '3', icon: '🎓', t: 'المتابعة ومراقبة النجاح', d: 'نرافق طفلك باستمرار، ونعدّل الخطة عند الحاجة، ونطلعك بانتظام على التقدم.', side: 'right' },
            ].map((s, i) => (
          ...
          <div style={{ textAlign: 'center', marginTop: '24px', display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="#kontakt" style={{ backgroundColor: '#FFD60A', color: '#0F2A45', padding: '14px 22px', borderRadius: '8px', textDecoration: 'none', fontWeight: '700', fontSize: '15px' }}>احصل على استشارة مجانية</a>
      ...
      <section className="section-pad" style={{ padding: '72px 32px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          <p style={{ fontSize: '12px', color: '#3A86FF', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '12px', textAlign: 'center', fontWeight: '600' }}>الباقات</p>
          ...
          <div className="pakete-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px' }}>
            {[
              { t: 'الأساسية', sub: 'بداية متينة.', key: 'basis', punkte: ['مرة واحدة 90 دقيقة أسبوعياً', 'مجموعة صغيرة (4 طلاب كحد أقصى)', 'مساعدة في الواجبات', 'توثيق التقدم'], highlight: false },
              { t: 'القياسية', sub: 'موصى بها لمعظم العائلات.', key: 'standard', punkte: ['مرتان 90 دقيقة أسبوعياً', 'مجموعة صغيرة (4 طلاب كحد أقصى)', 'وتيرة تعلّم فردية', 'تغذية راجعة منتظمة للأهل', 'تحليل شهري للتقدم', 'تحضير للامتحانات مشمول', 'تحليل الفجوات وتمارين موجهة'], highlight: true },
              { t: 'بريميوم', sub: 'الباقة الشاملة.', key: 'premium', punkte: ['دروس فردية حصرية 1:1', 'دعم واتساب من الإثنين إلى السبت', 'تقارير نجاح استباقية', 'جدولة مواعيد مرنة'], highlight: false },
            ].map(p => (
              <div key={p.t} style={{ border: p.highlight ? '2px solid #0F2A45' : '1px solid #E8EDF2', borderRadius: '12px', padding: '28px', position: 'relative', backgroundColor: p.highlight ? '#0F2A45' : '#fff' }}>
                {p.highlight && <div style={{ position: 'absolute', top: '-12px', left: '50%', transform: 'translateX(-50%)', backgroundColor: '#FFD60A', color: '#0F2A45', fontSize: '11px', fontWeight: '700', padding: '4px 14px', borderRadius: '20px', whiteSpace: 'nowrap' }}>موصى بها لمعظم العائلات</div>}
      ...
      <section className="section-pad" style={{ background: 'linear-gradient(135deg, #EEF4FF 0%, #F7F9FC 100%)', borderTop: '1px solid #D6E4FF', borderBottom: '1px solid #D6E4FF', padding: '72px 32px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: '800', marginBottom: '8px', textAlign: 'center', color: '#0F2A45' }}>ماذا تقول عائلاتنا</h2>
          ...
          <div className="grid-2" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px' }}>
            {[
              { name: 'عمرو ع', text: 'دروس خصوصية ممتازة! تحسّن طفلي بشكل ملحوظ في وقت قصير. الشرح واضح وودود. نحن سعداء جداً!' },
              { name: 'Abod A.', text: 'المعلمون لطفاء ويشرحون كل شيء بوضوح. طفلي يحرز تقدماً جيداً. نحن سعداء وممتنون جداً.' },
              { name: 'Samer A.', text: 'تمكّنت من سدّ الفجوات لديّ وأصبحت أشعر بثقة أكبر في المدرسة، خاصة في الامتحانات.' },
              { name: 'Abdulkader O.', text: 'دوام التوفيق لمشروعكم الذي يهدف لتعزيز قدرات أبنائنا في اللغة الالمانية والإنكليزية.' },
              { name: 'Nora H.', text: 'شكرا لكم بفضلكم وبفضل جهودكم اولادي اصبحوا افضل وعلاماتهم جيدة.' },
            ].map(r => (
      ...
      <section style={{ position: 'relative', padding: '72px 24px', textAlign: 'center', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <img src="/st2.jpg" alt="الخلفية" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 30%' }} />
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(20px, 3vw, 30px)', fontWeight: '800', color: '#fff', marginBottom: '16px', lineHeight: '1.5' }}>
            معاً نبني ثقة جديدة بالنفس ونسدّ الفجوات المعرفية بشكل دائم.
          </h2>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap', margin: '20px 0 28px' }}>
            {['أونلاين أو في المنزل', 'مناسب للعائلات', 'ابدأ فوراً'].map(f => (
      ...
      <section id="kontakt" className="section-pad" style={{ padding: '72px 32px', backgroundColor: '#fff' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          <p style={{ fontSize: '12px', color: '#3A86FF', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '12px', textAlign: 'center', fontWeight: '600' }}>تواصل معنا</p>
          ...
          <p style={{ fontSize: '15px', color: '#556678', textAlign: 'center', marginBottom: '36px' }}>املأ النموذج — سنتواصل معك خلال 24 ساعة عبر واتساب.</p>
          <div style={{ backgroundColor: '#F7F9FC', border: '1px solid #E8EDF2', borderRadius: '16px', padding: '32px' }}>
            <div className="form-row" style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: '13px', fontWeight: '600', color: '#0F2A45', display: 'block', marginBottom: '6px' }}>اسمك *</label>
                <input
                  type="text"
            ...
            <div className="form-row" style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: '13px', fontWeight: '600', color: '#0F2A45', display: 'block', marginBottom: '6px' }}>واتساب / الهاتف *</label>
                <input
                  type="tel"
            ...
            <p style={{ fontSize: '12px', color: '#8A9BAE', textAlign: 'center', marginTop: '12px' }}>
              عند الإرسال، سيُفتح واتساب مع طلبك. نردّ خلال 24 ساعة.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="initiative-inner" style={{ maxWidth: '880px', margin: '0 auto', backgroundColor: '#fff', borderRadius: '16px', padding: '36px 44px', display: 'flex', gap: '32px', alignItems: 'center', flexWrap: 'wrap', boxShadow: '0 4px 24px rgba(58,134,255,0.08)', border: '1px solid #D6E4FF' }}>
          <div style={{ flex: 1, minWidth: '240px' }}>
            ...
            <p style={{ fontSize: '15px', color: '#556678', lineHeight: '1.8', margin: 0 }}>
              هل تحصل على <strong>Wohngeld أو Bürgergeld</strong> أو <strong>Kinderzuschuss</strong>؟ إذاً فالدروس الخصوصية <strong>مجانية 100%</strong> لك عبر برنامج التعليم والمشاركة (BuT).
            </p>
          </div>
          <a href={waLink(msgs.but)} target="_blank" style={{ backgroundColor: '#FFD60A', color: '#0F2A45', padding: '14px 22px', borderRadius: '8px', textDecoration: 'none', fontWeight: '700', fontSize: '15px', whiteSpace: 'nowrap' }}>تحقق من الأهلية مجاناً</a>
        </div>
      </section>

      {/* PARTNER */}
      <section style={{ padding: '44px 24px', borderBottom: '1px solid #E8EDF2', textAlign: 'center' }}>
        <p style={{ fontSize: '12px', color: '#3A86FF', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '20px', fontWeight: '600' }}>شريكنا</p>
      ...
      <section className="section-pad" style={{ background: 'linear-gradient(135deg, #EEF4FF 0%, #F7F9FC 100%)', padding: '72px 24px' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: '800', marginBottom: '40px', textAlign: 'center', color: '#0F2A45' }}>الأسئلة المتكررة</h2>
          {[
            { f: 'كم عدد حصص الدعم في الأسبوع المنطقي؟', a: 'عادةً نوصي بموعد إلى موعدين أسبوعياً. قبل الامتحانات المهمة، قد يكون الدعم المكثّف مفيداً لفترة قصيرة.' },
            { f: 'ما المواد والمراحل الدراسية التي نغطيها؟', a: 'نقدّم الدعم في جميع المواد من المرحلة الابتدائية حتى الثانوية — الرياضيات، الألمانية، الإنجليزية، العلوم والمزيد.' },
            { f: 'هل يمكنني الإلغاء شهرياً؟', a: 'نعم — لا التزام طويل الأمد. بالساعة أو بانتظام، كما يناسبك.' },
            { f: 'من يُدرّس في Lern²؟', a: 'معلمون متفانون، طلاب جامعيون وخريجو ثانوية بدرجات ممتازة — يعملون بصبر وتحفيز.' },
          ].map((q, i) => (
            <div key={i} style={{ borderBottom: '1px solid #D6E4FF', backgroundColor: openFaq === i ? '#fff' : 'transparent', borderRadius: openFaq === i ? '8px' : '0', marginBottom: openFaq === i ? '8px' : '0' }}>
              ...
              {openFaq === i && (
                <div style={{ padding: '0 16px 18px' }}>
                  <p style={{ fontSize: '15px', color: '#556678', lineHeight: '1.8', margin: 0 }}>{q.a}</p>
                </div>
              )}
            </div>
          ))}
      ...
      <footer style={{ backgroundColor: '#FFD60A', padding: '44px 24px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '12px', color: '#0F2A45', opacity: 0.6 }}>صُنع بـ ❤️ من أجل مستقبل أطفالنا</p>
        </div>
      </footer>
