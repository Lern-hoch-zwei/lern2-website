...
export default function AnmeldungForm({ lang }: { lang: Lang }) {
  ...
  const selectStyle: React.CSSProperties = {
    ...
    paddingRight: rtl ? '14px' : '34px',
    paddingLeft: rtl ? '34px' : '14px',
    ...
    backgroundPosition: rtl ? 'left 10px center' : 'right 10px center',
    backgroundSize: '12px',
  };
            ...
            <div>
              ...
              <div className="form-row-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', marginBottom: '14px' }}>
                ...
                <div>
                  ...
                  <select value={form.klassenstufe} onChange={(e) => upd('klassenstufe', e.target.value)} style={selectStyle}>
          ...
          {step === 3 && (
            <div>
              ...
              <div style={{ marginBottom: '14px' }}>
                ...
                <select value={form.unterrichtsform} onChange={(e) => upd('unterrichtsform', e.target.value)} style={selectStyle}>
                  <option value="">{tt.bitteWaehlen}</option>
              ...
              <div className="form-row-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', marginBottom: '14px' }}>
                <div>
                  ...
                  <select value={form.staatl_unterstuetzung} onChange={(e) => upd('staatl_unterstuetzung', e.target.value)} style={selectStyle}>
                    <option value="">{tt.bitteWaehlen}</option>
                ...
                <div>
                  ...
                  <select value={form.bewilligungsbescheid} onChange={(e) => upd('bewilligungsbescheid', e.target.value)} style={selectStyle}>
                    <option value="">{tt.bitteWaehlen}</option>
              ...
              <div style={{ marginBottom: '14px' }}>
                ...
                <select value={form.kommunikation} onChange={(e) => upd('kommunikation', e.target.value)} style={selectStyle}>
                  <option value="">{tt.bitteWaehlen}</option>
